...
import { longsorBulananByProvinsi, getCurahHujanHarian, bulanOptions, wilayahByProvinsi, getLatestMetrics } from "../data/realData";
...
export default function FaktorLongsorPage({ provinsi }) {
  ...
  const kpis = [
    { label: "Jenis/Struktur Tanah", value: "Data tanah tersedia" },
    { label: "Kemiringan Lereng", value: `${metrics.slope.toFixed(2)} derajat` },
    { label: "Tutupan Lahan (NDVI & NDBI)", value: `NDVI: ${metrics.ndvi.toFixed(2)} / NDBI: ${metrics.ndbi.toFixed(2)}` },
    { label: "Soil Moisture", value: `${metrics.moisture.toFixed(2)}` },
  ];
    ...
    <div className="space-y-4" style={{ fontFamily: "var(--font-dm-sans)" }}>
      ...
      <GlassCard className="p-4">
        <div className="flex items-center gap-3 mb-4 flex-wrap">
          <span className="text-[12px] font-semibold" style={{ color: "#2C3E50" }}>Tren Longsor</span>
          ...
          <DropdownPill
            ...
            tooltip="Anda telah memilih tren kejadian longsor harian"
          />
          <DropdownPill
            value={bulan}
        ...
        <ResponsiveContainer width="100%" height={200}>
          <LineChart data={chartData} margin={{ top: 4, right: 8, bottom: 4, left: -10 }}>
            ...
            <Line type="monotone" dataKey="solid"  stroke="rgba(44,62,80,0.85)" strokeWidth={2}   dot={false} name="Longsor" />
      ...
      <GlassCard className="p-4">
        {/* Controls */}
        <div className="flex items-center gap-3 mb-4 flex-wrap">
          <span className="text-[12px] font-semibold" style={{ color: "#2C3E50" }}>Peta Potensi Longsor</span>
        ...
        <div className="flex gap-4" style={{ minHeight: "280px" }}>
          ...
          <div className="w-52 flex-shrink-0 flex items-start pt-2">
            {selectedWilayah ? (
              <MapDetailPanel
