  ...
  return (
    <div className="m6-map-container" ref={mapRef}>
      <svg viewBox="0 0 280 400" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
        ...
        <path
          d="M175,20 C180,25 185,30 182,40 C180,48 178,52 176,58 C174,64 172,68 170,74 C168,78 165,82 163,88 C160,94 158,98 155,104 C152,108 150,112 148,118 C145,124 142,128 140,134 C138,138 135,142 133,148 C130,154 128,158 126,164 C123,170 120,176 118,182 C115,188 112,194 110,200 C108,206 105,210 102,216 C100,222 97,226 95,232 C92,238 90,242 87,248 C85,254 82,258 80,264 C77,270 75,276 73,282 C70,288 68,294 65,300 C63,306 62,310 60,316 C58,322 57,328 56,334 C55,340 55,346 56,352 C57,356 59,358 62,360 C66,362 70,363 75,362 C80,360 85,357 90,354 C95,350 100,346 105,342 C110,338 115,334 120,328 C125,322 128,316 132,310 C136,304 138,298 142,292 C146,286 148,280 152,274 C155,268 157,262 160,256 C162,250 164,244 166,238 C168,232 170,226 172,220 C174,214 176,208 177,202 C178,196 179,190 180,184 C181,178 181,172 181,166 C181,160 180,154 180,148 C179,142 178,136 178,130 C178,124 178,118 178,112 C178,106 178,100 178,94 C178,88 178,82 178,76 C178,70 178,64 177,58 C177,52 176,46 176,40 C176,34 175,28 175,20Z"
          fill="#e8e8e8"
          stroke="#fff"
          strokeWidth="1.5"
